...
# Instead, please edit 02-input-file-format.md in _episodes_rmd/
...
~~~
[1] "/Users/smc/Projects/Lessons/gene-expression-qtl/_episodes_rmd"
~~~
{: .output}
...
~~~
Warning in file(file, "rt"): cannot open file '../data/clinical phenotypes for
eQTL paper.csv': No such file or directory
~~~
{: .warning}
...
~~~
Error in colnames(pheno_clin) %in% pheno2keep$short_name: object 'pheno2keep' not found
~~~
{: .error}
